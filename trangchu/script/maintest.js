// Danh sách vật phẩm
const items = [
    { name: "Nô lệ Hiếu Bùi", type: "nole", img: "nole/bhieu.jpg", gia: 10, increment: 1, unit: "Tiền mỗi giây", quantity: 0 },
    { name: "Gậy đánh chó", type: "tool", img: "tools/gaydanhcho.png", gia: 10, increment: 1, unit: "Tiền mỗi click", quantity: 0 },
    { name: "Nô lệ Trung Bùi", type: "nole", img: "nole/trung.jpg", gia: 500, increment: 10, unit: "Tiền mỗi giây", quantity: 0 },
    { name: "Búa gõ đầu", type: "tool", img: "tools/buagodau.png", gia: 100, increment: 10, unit: "Tiền mỗi click", quantity: 0 },
    { name: "Nô lệ Vinh đần", type: "nole", img: "nole/vinh.jpg", gia: 5000, increment: 100, unit: "Tiền mỗi giây", quantity: 0 },
    { name: "Kiếm cùn", type: "tool", img: "tools/kiemcun.png", gia: 1000, increment: 100, unit: "Tiền mỗi click", quantity: 0 },
    { name: "Nô lệ Huy", type: "nole", img: "nole/huy.jpg", gia: 50000, increment: 1000, unit: "Tiền mỗi giây", quantity: 0 },
    { name: "Rìu cứu hỏa", type: "tool", img: "tools/riucuuhoa.jpg", gia: 10000, increment: 1000, unit: "Tiền mỗi click", quantity: 0 },
    { name: "Nô lệ Khoa", type: "nole", img: "nole/khoa.jpg", gia: 500000, increment: 10000, unit: "Tiền mỗi giây", quantity: 0 },
    { name: "Lightsaber", type: "tool", img: "tools/kiemanhsang.png", gia: 100000, increment: 10000, unit: "Tiền mỗi click", quantity: 0 },
    { name: "Nô lệ Hào", type: "nole", img: "nole/hao.jpg", gia: 5000000, increment: 100000, unit: "Tiền mỗi giây", quantity: 0 },
    { name: "Kiếm thánh Excalibur", type: "tool", img: "tools/excalibur.png", gia: 1000000, increment: 100000, unit: "Tiền mỗi click", quantity: 0 }
];

const rareitems = [
    { name: "Thánh dược Elixir", type: "elixir", img: "tools/exilir.png", increment: 2, unit: "Tiền mỗi giây", percent: 50, quantity: 0 },
    { name: "Thiên thạch", type: "grindstone", img: "tools/damai.png", increment: 2, unit: "Tiền mỗi click", percent: 50, quantity: 0 }
]
...
function buyItem(index) {
    ...
    if (money >= item.gia) {
        ...
        // Cập nhật giao diện
        document.getElementById(`soluong${item.type}${index}`).textContent = `${item.name}: ${item.quantity}`;
        document.getElementById(`gia${item.type}${index}`).textContent = `Giá: ${item.gia} VNĐ`;
        updateDisplay();
    } else {
        alert("Không đủ tiền!");
    }
...
function openChest() {
    ...
    if (money >= 500) { // Giả sử mỗi lần mở rương tốn 500 VNĐ
        ...
        if (selectedItem.name === "Thánh dược Elixir") {
            ...
            document.getElementById(`soluongelixir0`).textContent = `Thánh dược Elixir: ${rareitems[0].quantity}`;
        } else if (selectedItem.name === "Thiên thạch") {
            hasGrindstone = true;
            rareitems[1].quantity += 1;
            document.getElementById(`soluonggrindstone1`).textContent = `Thiên thạch: ${rareitems[1].quantity}`;
        }
